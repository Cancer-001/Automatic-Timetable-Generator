...
<div class="container-fluid py-4">
    ...
    <div class="card"><div class="card-body"><div id="facultyCalendar"></div></div></div>
</div>
...
$(function(){
    loadSessions();
    facultyCalendar = new FullCalendar.Calendar(document.getElementById('facultyCalendar'), {
    ...
    $('#calReload,#calSession').on('click change', function(){ facultyCalendar.refetchEvents(); });
});
</script>
