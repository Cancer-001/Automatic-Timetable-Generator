...
<nav class="navbar navbar-expand-lg navbar-dark app-header">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">📅 Timetable System <span class="badge bg-light text-primary ms-1">Faculty</span></a>
        <div class="navbar-nav ms-auto">
            ...
            <a class="nav-link<?php echo $currentPath === 'availability.php' ? ' active' : ''; ?>" href="availability.php">Availability</a>
            <a class="nav-link<?php echo $currentPath === 'substitution.php' ? ' active' : ''; ?>" href="substitution.php">Substitution</a>
